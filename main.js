...
// LISTE NOIRE STRICTE : On écrit les noms exacts en minuscules
...
loader.load(
    ...
    (gltf) => {
        ...
        // Tri des objets cliquables (Exclusion de la liste noire)
...
function handleInteraction(clientX, clientY) {
    ...
    if (intersects.length > 0) {
        ...
        // Affichage temporaire du nom brut (en attendant tes textes personnalisés !)
        document.getElementById('info-title').innerText = "Élément détecté";
        document.getElementById('info-description').innerText = `Tu as cliqué sur : ${hitObject.name}`;
